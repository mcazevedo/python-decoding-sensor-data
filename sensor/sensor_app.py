...
# Instanciate the house_info object and assign values to variables
house_info = HouseInfo(data)
test_area = 1
test_date = datetime.strptime("5/9/20", "%m/%d/%y")

# Count the number of records to analyze
...
# Instantiate the temperature data object
...
# Instantiate the humidity object
